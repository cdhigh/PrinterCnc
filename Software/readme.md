...
##控制板模拟器说明
    ...
    *因为屏幕分辨率的局限，模拟器画图经常需要四舍五入，所以和真实的绘图效果也会有一些偏差，比如线条没有完全连接等。
...
##Sprint-layout注意事项：
    ...
    * Sprint-layout 6.0遵循的gerber版本比较老，特别是其一般不使用焊盘内孔标准，所以上位机输出的焊盘可能没有内孔，即使选择了界面上的“强制开孔”选项，因为有时候其使用一些图案组合成焊盘，而不是直接使用焊盘gerber代码。
