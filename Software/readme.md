...
##配置文件说明
    * 软件使用ini配置文件保存配置，除了界面上的显而易见的参数配置外，此节描述几个不在界面上显示的参数
...
##控制板模拟器说明
    ...
    * 因为控制板性能和特性所限，上位机使用海量的水平线和垂直线组成所需要的任何图案，如果输出至模拟器时，因为绘图对象太多，所以速度会很慢，会有一段时间的界面“未响应”，稍等候即可，根据图案的大小和复杂程度，绘图时间可能从几秒到几十秒。
